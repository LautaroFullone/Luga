                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                    ...
                                    <div
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span
                                                        class="fas fa-poll-h {{ config('adminlte.classes_auth_icon', '') }}"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span
                                                        class="fas fa-adjust {{ config('adminlte.classes_auth_icon', '') }}"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group mb-2">
                                            <input type="text" name="codigo_postal_fiscal" class="form-control"
                                                placeholder="Codigo Postal">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span
                                                        class="fas fa-map-pin {{ config('adminlte.classes_auth_icon', '') }}"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <div style="padding-right: 10px" class="input-group-append">
                                                <div class="input-group-text">
                                                    <span
                                                        class="fas fa-building"></span>
                                                </div>
                                            </div>

                                            <input style="padding-left: 10px" type="text" name="departamento_fiscal"
                                                class="form-control" placeholder="Departamento">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span
                                ...
                                {{-- Card Box --}}
                                <div style="margin-top: 25px;" class="card {{ config('adminlte.classes_auth_card', 'card-outline card-primary') }}">
